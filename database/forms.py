...
class ArticleForm(FlaskForm):
    title = StringField('Заголовок', validators=[DataRequired(message='Напишите заголовок')])
    intro = StringField('Краткое описание', validators=[DataRequired(message='Введите краткое описание')])
